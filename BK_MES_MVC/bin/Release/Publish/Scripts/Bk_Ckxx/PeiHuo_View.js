...
oTableInit.InitSubTable_3 = function (value, row, $detai3) {
    ...
    var html3 = '<div id="toolbar_3" class="btn-group"><button id = "btn_ph" type = "button" class= "btn btn-default" data-toggle="modal" onclick="btn_ph(\'' + row.zdbh + '\',\''+row.cpmc+'\',\''+row.gg+'\',\''+row.gh+'\',\''+row.zb+'\')" ></span>手工配货</button></div>';
...
function btn_ph(id,cpmc,gh,gg,zb) {
    stxt_set(id,cpmc, gh, gg,zb);
