$(function () {
    ...
    $('#btn_find').click(function () {
        ...
        if (isRefresh) {
            ...
            $('#ArbetTable').bootstrapTable('refresh', {
                url: '/BK_Ckxx/RuKu_Report?ishz=1'
            });
            isRefresh = true;
        }
    ...
    $('#btn_print').click(function () {
        ...
        window.location.href = "/Bk_Ckxx/Ruku_Hz_Print?gh=" + gh + "&gg=" + gg + "&zb=" + zb + "&khbm=" + khbm + "&hz=" + hz + "&rq1=" + rq1 + "&rq2=" + rq2;
    ...
    myTables_url = '';///Bk_ckxx/RuKu_Report';
